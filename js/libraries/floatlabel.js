...
;(function ( $, window, document, undefined ) {
        ...
        Plugin.prototype = {
            init: function () {
                ...
                thisElement.wrap('<div class="floatlabel-wrapper" style="position:relative;display:inline-block"></div>');
                ...
                thisElement.on('blur keyup change', function( e ) {
                    self.checkValue( e );
                });
				var msie = window.navigator.userAgent.indexOf("MSIE ");
                thisElement.on('blur', function() {
					thisElement.prev('label').css({ 'color' : '#838780' });
					if ((msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) && thisElement.val() === "" )      // If Internet Explorer, return version number
						self.hideLabel();
				});
                thisElement.on('focus', function() {
					thisElement.prev('label').css({ 'color' : '#2996cc' });
            ...
            checkValue: function( e ) {
				...
				var msie = window.navigator.userAgent.indexOf("MSIE ");
				if( thisElement.data('flout') === '0' && currentFlout !== '0' && !(msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))) { //&& currentFlout !== '0') {//
                    this.hideLabel();
                }
            },
            showLabel: function() {
            ...
            hideLabel: function() {
				...
				var trans = self.settings.transitionDuration * 1000;
                window.setTimeout(function() {
